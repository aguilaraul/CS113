...
public class BinarySearchTree<E extends Comparable<E>> extends BinaryTree<E> implements SearchTree<E> {
     ...
     * that indicated whether the item has been inserted
     */
    ...
    private Node<E> add(Node<E> localRoot, E item) {
        if(localRoot == null) {
            ...
            // item is equal ti localRoot.data
            addReturn = false;
            return localRoot;
        } else if (item.compareTo(localRoot.data) < 0) {
     ...
     *      deleteReturn is equal to the deleted item as it was stored
